...
-- Insert sample templates (you'll replace these with your actual Canva template IDs)
INSERT INTO canva_templates (name, description, category, template_id, canva_url, preview_image_url, display_order) VALUES
  (
