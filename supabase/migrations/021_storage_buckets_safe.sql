-- Create Storage Buckets for Agent Portal (Safe Version)

-- Insert storage buckets (only if they don't exist)
...
-- Create RLS Policies for brand-assets (public read, admin write)
...
-- Create RLS Policies for training-resources (public read, admin write)
...
-- Create RLS Policies for marketing-files (agents can manage their own)
...
-- Create RLS Policies for support-attachments (agents can manage their own)
...
-- Create RLS Policies for profile-photos (public read, users can manage their own)
...
-- Create RLS Policies for announcement-files (public read, admin write)
