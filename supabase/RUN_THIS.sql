-- ==================================================================
-- SINGLE SQL SCRIPT - RUN THIS IN SUPABASE SQL EDITOR
-- ==================================================================

-- Part 1: Storage Policies for property-listings bucket
-- ==================================================================
...
-- Part 2: Enhance Existing Listings
-- ==================================================================
...
SET
  ...
  features = '{"laundry":"In-unit","parking":"Garage","lawn":true,"pool":false,"gym":true,"petFriendly":true,"furnished":false,"airConditioning":true,"heating":"Central","dishwasher":true,"refrigerator":true,"microwave":true,"oven":true,"washer":true,"dryer":true,"balcony":true,"garageSpaces":2,"storage":true,"security":true,"gatedCommunity":false,"utilities":["Water","Trash","Sewer"],"amenities":["Fitness Center","Concierge","Elevator"]}'::jsonb
...
SET
  ...
  features = '{"laundry":"In-unit","parking":"Garage","lawn":false,"pool":true,"gym":true,"petFriendly":true,"furnished":false,"airConditioning":true,"heating":"Central","dishwasher":true,"refrigerator":true,"microwave":true,"oven":true,"washer":true,"dryer":true,"patio":true,"balcony":true,"garageSpaces":3,"spa":false,"elevator":true,"fireplace":true,"storage":true,"security":true,"gatedCommunity":true,"utilities":["Water","Trash"],"amenities":["Pool","Spa","Fitness Center","Concierge","Rooftop Terrace"]}'::jsonb
...
SET
  ...
  features = '{"laundry":"Shared","parking":"Garage","lawn":false,"pool":false,"gym":true,"petFriendly":false,"furnished":false,"airConditioning":true,"heating":"Central","dishwasher":false,"refrigerator":true,"microwave":true,"oven":true,"balcony":false,"garageSpaces":1,"elevator":true,"storage":false,"security":true,"gatedCommunity":false,"utilities":["Water","Trash","Sewer"],"amenities":["Fitness Center","Elevator","Laundry Room"]}'::jsonb
...
SET
  ...
  features = '{"laundry":"In-unit","parking":"Garage","lawn":false,"pool":true,"gym":true,"petFriendly":true,"furnished":false,"airConditioning":true,"heating":"Central","dishwasher":true,"refrigerator":true,"microwave":true,"oven":true,"washer":true,"dryer":true,"patio":false,"balcony":true,"garageSpaces":3,"elevator":true,"fireplace":true,"storage":true,"security":true,"gatedCommunity":true,"utilities":["Water","Trash"],"amenities":["Pool","Fitness Center","Concierge","Game Room","Business Center"]}'::jsonb
...
SET
  ...
  features = '{"laundry":"In-unit","parking":"Garage","lawn":false,"pool":false,"gym":true,"petFriendly":true,"furnished":false,"airConditioning":true,"heating":"Central","dishwasher":true,"refrigerator":true,"microwave":true,"oven":true,"washer":true,"dryer":true,"balcony":true,"garageSpaces":1,"elevator":true,"storage":true,"security":true,"gatedCommunity":false,"utilities":["Water","Trash"],"amenities":["Fitness Center","Concierge","Package Room"]}'::jsonb
...
SET
  ...
  features = '{"laundry":"In-unit","parking":"Garage","lawn":false,"pool":false,"gym":false,"petFriendly":true,"furnished":false,"airConditioning":true,"heating":"Central","dishwasher":true,"refrigerator":true,"microwave":true,"oven":true,"washer":true,"dryer":true,"balcony":false,"garageSpaces":1,"elevator":true,"storage":true,"security":false,"gatedCommunity":false,"utilities":["Water","Trash","Sewer"],"amenities":["Elevator","Storage"]}'::jsonb
...
SET
  ...
  features = '{"laundry":"Shared","parking":"Garage","lawn":false,"pool":false,"gym":false,"petFriendly":false,"furnished":false,"airConditioning":true,"heating":"Central","dishwasher":false,"refrigerator":true,"microwave":true,"oven":true,"balcony":false,"garageSpaces":1,"elevator":true,"storage":false,"security":false,"gatedCommunity":false,"utilities":["Water","Trash","Sewer"],"amenities":["Elevator","Courtyard","Laundry Room"]}'::jsonb
...
SET
  ...
  features = '{"laundry":"In-unit","parking":"Garage","lawn":true,"pool":false,"gym":false,"petFriendly":true,"furnished":false,"airConditioning":true,"heating":"Central","dishwasher":true,"refrigerator":true,"microwave":true,"oven":true,"washer":true,"dryer":true,"garden":true,"patio":true,"garageSpaces":2,"storage":true,"security":false,"gatedCommunity":false,"utilities":["Water","Trash"],"amenities":["Private Garden","Patio"]}'::jsonb
...
SET
  ...
  features = '{"laundry":"In-unit","parking":"Garage","lawn":true,"pool":false,"gym":false,"petFriendly":true,"furnished":false,"airConditioning":true,"heating":"Central","dishwasher":true,"refrigerator":true,"microwave":true,"oven":true,"washer":true,"dryer":true,"garden":true,"patio":true,"deck":true,"garageSpaces":2,"storage":true,"security":false,"gatedCommunity":false,"utilities":["Water","Trash","Sewer"],"amenities":["Private Garden","Patio","Deck"]}'::jsonb
