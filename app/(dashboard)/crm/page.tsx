  ...
  return (
    <Box sx={{ minHeight: '100%', display: 'flex', flexDirection: 'column', backgroundColor: '#000000' }}>
          ...
          <Box sx={{ p: 2, height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
            ...
            <Box sx={{ position: 'sticky', top: 0, zIndex: 10, p: 2, backgroundColor: '#111111', borderBottom: '1px solid rgba(226, 192, 90, 0.08)', display: 'flex', gap: 2, flexWrap: 'wrap', flexShrink: 0 }}>
              ...
              <FormControl size="small" sx={{ minWidth: '140px' }}>
                <InputLabel sx={{ color: '#aaaaaa' }}>Status</InputLabel>
                <Select
                  value={statusFilter}
                  label="Status"
                  ...
                  sx={{
                    backgroundColor: '#000000',
                    color: '#FFFFFF',
                    '& .MuiOutlinedInput-notchedOutline': { borderColor: 'rgba(226, 192, 90, 0.08)' },
                  }}
                >
              ...
              <FormControl size="small" sx={{ minWidth: '150px' }}>
                <InputLabel sx={{ color: '#aaaaaa' }}>Lead Type</InputLabel>
                <Select
                        ...
                        <CardContent sx={{ flexGrow: 1, p: 2 }}>
                          ...
                          {contact.email && (
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mb: 1 }}>
                              <Envelope size={14} color="#aaaaaa" weight="duotone" />
                              <Typography
                                component="a"
                          ...
                          {contact.phone && (
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mb: 2 }}>
                              <Phone size={14} color="#aaaaaa" weight="duotone" />
                              <Typography
                                component="a"
                    ...
                    >
                      <CardContent sx={{ flexGrow: 1, p: 2 }}>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mt: 'auto' }}>
                          <CalendarBlank size={14} color="#aaaaaa" weight="duotone" />
                          <Typography
                            variant="caption"
                            sx={{
            ...
            <Box sx={{
              ...
              {calendarLoading ? (
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flex: 1 }}>
                  <Typography sx={{ color: '#aaaaaa' }}>Loading calendar...</Typography>
                </Box>
              ) : (
                    ...
                    <Box sx={{
                      ...
                      <TableContainer>
                        <Table>
                          <TableHead>
                            <TableRow>
                              <TableCell sx={{ color: '#aaaaaa', fontWeight: 600, borderBottom: '1px solid rgba(226, 192, 90, 0.08)', fontSize: '0.75rem' }}>Date</TableCell>
                              <TableCell sx={{ color: '#aaaaaa', fontWeight: 600, borderBottom: '1px solid rgba(226, 192, 90, 0.08)', fontSize: '0.75rem' }}>Time</TableCell>
                              <TableCell sx={{ color: '#aaaaaa', fontWeight: 600, borderBottom: '1px solid rgba(226, 192, 90, 0.08)', fontSize: '0.75rem' }}>Event</TableCell>
                              <TableCell sx={{ color: '#aaaaaa', fontWeight: 600, borderBottom: '1px solid rgba(226, 192, 90, 0.08)', fontSize: '0.75rem' }}>Type</TableCell>
                            </TableRow>
                          </TableHead>
                          <TableBody>
                            {(() => {
                              ...
                              if (upcomingEvents.length === 0) {
                                return (
                                  <TableRow>
                                    <TableCell colSpan={4} sx={{ textAlign: 'center', py: 4, color: '#808080', borderBottom: '1px solid rgba(226, 192, 90, 0.08)' }}>
                                ...
                                return events.map((event: any, eventIndex: number) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <TableCell sx={{ color: '#aaaaaa', borderBottom: '1px solid rgba(226, 192, 90, 0.08)', whiteSpace: 'nowrap', fontSize: '0.75rem', py: 1 }}>
                                        {eventTime}
                                      </TableCell>
                                      <TableCell sx={{ color: '#FFFFFF', borderBottom: '1px solid rgba(226, 192, 90, 0.08)', fontSize: '0.75rem', py: 1 }}>
                                        {event.title}
                                      </TableCell>
                                      <TableCell sx={{ borderBottom: '1px solid rgba(226, 192, 90, 0.08)', py: 1 }}>
                                        <Chip
                                          label={typeLabel}
                                          size="small"
                                          sx={{
          ...
          <Grid container spacing={2} sx={{ mt: 1 }}>
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth>
                <InputLabel sx={{ color: '#aaaaaa' }}>Contact Type</InputLabel>
                <Select
      ...
      <Dialog open={dealDialogOpen} onClose={() => setDealDialogOpen(false)} maxWidth="sm" fullWidth sx={dashboardStyles.dialog}>
        ...
        <DialogContent sx={dashboardStyles.dialog}>
          <Grid container spacing={2} sx={{ mt: 1 }}>
            ...
            <Grid item xs={12}>
              <FormControl fullWidth>
                <InputLabel sx={{ color: '#aaaaaa' }}>Contact</InputLabel>
                <Select
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth>
                <InputLabel sx={{ color: '#aaaaaa' }}>Stage</InputLabel>
                <Select
      ...
      <Dialog open={taskDialogOpen} onClose={() => setTaskDialogOpen(false)} maxWidth="sm" fullWidth sx={dashboardStyles.dialog}>
        ...
        <DialogContent sx={dashboardStyles.dialog}>
          <Grid container spacing={2} sx={{ mt: 1 }}>
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth>
                <InputLabel sx={{ color: '#aaaaaa' }}>Priority</InputLabel>
                <Select
      ...
      >
        ...
        <DialogActions sx={{ borderTop: '1px solid rgba(226, 192, 90, 0.08)', p: 2 }}>
          <Button
