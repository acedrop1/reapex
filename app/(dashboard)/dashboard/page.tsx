        ...
        <Grid item xs={12} md={7} sx={{ height: isMobile ? 'auto' : '100%', display: (isMobile && mobileTab === 2) ? 'none' : 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                <Box sx={{
                  ...
                  '&::-webkit-scrollbar-track': { backgroundColor: '#0D0D0D', borderRadius: '4px' },
          ...
          <Box sx={{ flex: 1, minHeight: 0, display: (isMobile && mobileTab !== 1) ? 'none' : 'flex', flexDirection: 'column' }}>
            ...
            {listings && listings.length > 0 ? (
              ...
              <Box sx={{ textAlign: 'center', py: 3, backgroundColor: '#0D0D0D', borderRadius: '8px', border: '1px solid #3A3A3A' }}>
                  ...
                  uniqueDates.map((date) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <Typography variant="body2" sx={{ color: '#B0B0B0', fontWeight: 500, fontSize: '0.75rem' }}>
                    ...
                    return (
                      <Box
                        ...
                        sx={{
                          ...
                          border: isToday ? '2px solid #E2C05A' : '1px solid #2A2A2A',
                          borderRadius: '6px',
                          display: 'flex',
                          flexDirection: 'column',
                          alignItems: 'center',
